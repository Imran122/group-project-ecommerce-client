            ...
            <div className="container">
                <div className="row m-0">
                    <div className="col-md-6 col-lg-3 ps-2 pe-3 mb-4">
                        <h3 className="footer-title" href="#">jozzBy</h3>
                        <p className='mb-1'>jozzBy is a trusted online based shopping website. We are seeing the quality best and the customer satisfaction.</p>
