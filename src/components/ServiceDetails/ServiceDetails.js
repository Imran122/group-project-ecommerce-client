            ...
            <div className="col-lg-6 mt-4">
              <div className="single-details-services text-start">
                ...
                <p className="my-4">
                  ...
                  aut consectetur exercitationem officiis? Praesentium facilis
                  repellendus modi molestias eius fugiat illo unde. Laudantium
                  laborum inventore placeat molestiae praesentium ipsum quod, at
                  ad aliquam ratione, dolor, quasi ex? Voluptatem, facere
                  ducimus? {getDetails?.description}
                </p>
                <h2 className="text-primary fw-bold">
                  Taka: {getDetails?.price}
                </h2>
              </div>
